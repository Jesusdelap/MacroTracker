...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "FATSECRET_CLIENT_ID", "\"${localProperties["FATSERCRET_CLIENT_ID"] ?: ""}\"")
        buildConfigField("String", "FATSECRET_CLIENT_SECRET", "\"${localProperties["FATSERCRET_KEY"] ?: ""}\"")
